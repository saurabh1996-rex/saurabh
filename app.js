...
function toggleSkills() {
  ...
  for (i = 0; i < skillContent.length; i++) {
    console.log(skillContent.length);
...
gsap.from('.home__title,.home__subtitle',{opacity:0, duration:1.2, y: -50 ,stagger: 0.5})
gsap.from('.home__blob',{duration:1, y: -50, delay:.6, opacity:0})
gsap.from('.home__button',{opacity:0, duration:1, y: 20, delay:1.2})
